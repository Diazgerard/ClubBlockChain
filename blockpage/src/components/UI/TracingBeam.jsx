...
import {
  ...
  useScroll,
  useSpring,
} from "framer-motion"; // usa 'framer-motion' directamente
  ...
  return (
    ...
    >
      <div className="absolute top-3 -left-4 md:-left-20 z-10">
        <motion.div
          className="border border-neutral-200 ml-[27px] flex h-4 w-4 items-center justify-center rounded-full shadow-sm"
          animate={{
            boxShadow:
